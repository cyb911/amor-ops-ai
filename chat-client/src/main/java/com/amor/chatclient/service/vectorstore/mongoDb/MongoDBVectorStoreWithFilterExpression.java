...
public class MongoDBVectorStoreWithFilterExpression extends AbstractObservationVectorStore {

	private static final Logger logger = LoggerFactory.getLogger(MongoDBVectorStoreWithFilterExpression.class);
	...
	protected MongoDBVectorStoreWithFilterExpression(SimpleVectorStoreWithFilterExpressionBuilder builder) {
		super(builder);
		this.objectMapper = JsonMapper.builder().addModules(JacksonUtils.instantiateAvailableModules()).build();
		this.expressionParser = new SpelExpressionParser();
		this.filterExpressionConverter = new MongoDBVectorStoreFilterExpressionConverter();
	}
	...
	public static final class SimpleVectorStoreWithFilterExpressionBuilder extends AbstractVectorStoreBuilder<SimpleVectorStoreWithFilterExpressionBuilder> {
		...
		@Override
		public MongoDBVectorStoreWithFilterExpression build() {
			return new MongoDBVectorStoreWithFilterExpression(this);
		}
